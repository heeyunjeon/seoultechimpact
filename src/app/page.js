    ...
    <div className={styles.container}>
      ...
      <div className={styles.bingoWrapper}>
        <div className={styles.gridContainer}>
          <div className={styles.gridItem} style={{ background: 'greenyellow' }}>
            <PiCigaretteFill color="black" size={50} onClick={() => handleButtonClick('ciggy')} /></div>
          <div className={styles.gridItem}>Ciggy</div>
          <div className={styles.gridItem}>Trash</div>
          <div className={styles.gridItem}>Toilet</div>
          <div className={styles.gridItem} style={{ background: 'greenyellow' }}>
            <FaTrashAlt color="black" size={50} onClick={() => handleButtonClick('trash')} style={{ background: 'greenyellow' }} /></div>
          ...
          <div className={styles.gridItem} style={{ background: 'greenyellow' }}>       <FaRestroom color="black" size={50} onClick={() => handleButtonClick('toilet')} /></div>
        </div>
      </div>
